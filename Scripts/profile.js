...
function toggleEditSave(button) {
  ...
  editableElements.forEach(
    (el) => (el.style.display = isEditing ? "block" : "none")
  );
  ...
  if (isEditing) {
    ...
    document.getElementById("out-healthID").textContent =
      document.getElementById("health-ID").value;
    document.getElementById("out-gender").textContent =
      document.getElementById("gender").value;
    document.getElementById("out-age").textContent =
      document.getElementById("age").value;
    document.getElementById("out-bloodGroup").textContent =
